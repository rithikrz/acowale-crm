...
3. **Environment Variables**: Set the following production variables:
   ...
   - `CORS_ORIGIN` = `https://acowale-crm.vercel.app` *(Change to your actual frontend domain)*
...
3. **Environment Variables**: Add:
   - `VITE_API_BASE` = `https://acowale-crm-api.up.railway.app/api` *(Point to your deployed backend URL + `/api` suffix)*
