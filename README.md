...
- **Frontend Dashboard**: `https://acowale-crm-frontend-ten.vercel.app`
- **Backend API Base**: `https://backend-production-412af.up.railway.app`
- **Backend Health Check**: `https://backend-production-412af.up.railway.app/health`
